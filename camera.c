...
//				printf("T 0x%X 0x%X 0x%X 0x%X 0x%X 0x%X 0x%X 0x%X\r\n", packet_buffer[0], packet_buffer[1], packet_buffer[2], packet_buffer[3], packet_buffer[4], packet_buffer[5], packet_buffer[6], packet_buffer[7]);
//				printf("T %d %d %d %d %d %d %d %d\r\n", T_Packet_Data.mx, T_Packet_Data.my, T_Packet_Data.x1, T_Packet_Data.y1, T_Packet_Data.x2, T_Packet_Data.y2, T_Packet_Data.pixels, T_Packet_Data.confidence);
				camera_t_packets++;
